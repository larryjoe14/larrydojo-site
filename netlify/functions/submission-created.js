      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background: #f4eee4; border: 3px solid #0a0a0a;">
        ...
        <tr><td style="padding: 20px 36px 8px;">
          <h1 style="margin: 0; font-family: 'Arial Black', 'Helvetica Neue', Arial, sans-serif; font-weight: 900; font-size: 56px; line-height: 0.9; letter-spacing: -0.03em; text-transform: uppercase; color: #0a0a0a;">
            Got<br><span style="color: #ff5b1f; -webkit-text-stroke: 2px #0a0a0a;">it.</span>
          </h1>
        </td></tr>
        <tr><td style="padding: 24px 36px 8px;">
          ...
          <p style="margin: 0; font-size: 16px; line-height: 1.55; color: #0a0a0a;">In the meantime, here's what's on the workbench.</p>
        </td></tr>
        ${messageBlock}
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td width="33%" valign="top" style="padding-right: 6px;">
                <a href="https://www.youtube.com/@larrydojo" style="display: block; background: #0a0a0a; color: #ffe000; text-decoration: none; padding: 14px 12px; border: 2px solid #0a0a0a; font-family: 'Arial Black', sans-serif; font-weight: 900; font-size: 12px; letter-spacing: 0.05em; text-transform: uppercase; text-align: center;">YouTube ↗</a>
              </td>
              <td width="33%" valign="top" style="padding: 0 3px;">
                <a href="https://www.tiktok.com/@larrydojo_noir" style="display: block; background: #0a0a0a; color: #ffe000; text-decoration: none; padding: 14px 12px; border: 2px solid #0a0a0a; font-family: 'Arial Black', sans-serif; font-weight: 900; font-size: 12px; letter-spacing: 0.05em; text-transform: uppercase; text-align: center;">TikTok ↗</a>
              </td>
              <td width="33%" valign="top" style="padding-left: 6px;">
                <a href="https://www.instagram.com/larrydojo/" style="display: block; background: #0a0a0a; color: #ffe000; text-decoration: none; padding: 14px 12px; border: 2px solid #0a0a0a; font-family: 'Arial Black', sans-serif; font-weight: 900; font-size: 12px; letter-spacing: 0.05em; text-transform: uppercase; text-align: center;">Instagram ↗</a>
              </td>
            </tr>
          </table>
        </td></tr>
        <tr><td style="padding: 0 36px 36px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #0a0a0a; border: 2px solid #0a0a0a;">
            <tr><td style="padding: 22px 22px 18px;">
              <div style="font-family: 'Brush Script MT', cursive; font-size: 18px; color: #ffe000; line-height: 1; margin-bottom: 6px;">↓ new case study</div>
